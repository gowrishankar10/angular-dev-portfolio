...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Professional green-based color system
        primary: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
        ...
        // Dark theme colors with green accents
        dark: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      fontSize: {
        'display-2xl': ['clamp(4rem, 8vw, 5.5rem)', { lineHeight: '1', letterSpacing: '-0.02em' }],
        'display-xl': ['clamp(3rem, 6vw, 4rem)', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
        'display-lg': ['clamp(2.5rem, 5vw, 3rem)', { lineHeight: '1.2', letterSpacing: '-0.01em' }],
      },
      backgroundImage: {
        'grid': `
        ...
        'subtle-glow': 'radial-gradient(600px circle at var(--mouse-x) var(--mouse-y), rgba(59, 130, 246, 0.15), transparent 40%)',
      },
      animation: {
      ...
      boxShadow: {
        ...
        'elegant': '0 32px 64px -12px rgba(0, 0, 0, 0.25)',
